...
from utils.constants import (GRID_HEIGHT_PX, GRID_WIDTH_PX, VOXEL_SIZE_M, BEV_PIXEL_OFFSET_X,
...
def prepare_gt_for_frame(
    ...
    for _, box_row in frame_gt.iterrows():
        try:
            # Read position — ego frame (positions preserved from preprocessing)
